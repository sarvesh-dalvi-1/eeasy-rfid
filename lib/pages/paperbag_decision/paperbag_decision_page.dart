          ...
          children: [
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  const Text('Would you like a paper bag',
                      style: TextStyle(
                          color: Color(0xff000C38), fontSize: 24, fontWeight: FontWeight.w600)),
                      ...
                      InkWell(
                        onTap: () async {
                          Provider.of<CheckoutProvider>(context, listen: false)
                              .populateCheckoutProductsFromTags(
                                  Provider.of<RfidReadProvider>(context, listen: false).tags);
                          Navigator.push(
            ...
            CBottomBar(
                ...
                onPrimaryTap: () => showDialog(context: context, builder: (_) => const SizedBox()))
          ],
        ),
      ),
    );
